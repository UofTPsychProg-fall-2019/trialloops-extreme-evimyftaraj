...
expName = 'stroopevi'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/evimyftaraj1/Desktop/stroopevi.py',
...
instrText = visual.TextStim(win=win, name='instrText',
    text='Choose the colour of the letters, ignoring the word:\n\nleft = red\ndown = green\nright = blue',
    font='Arial',
...
trials = data.TrialHandler(nReps=5, method='random', 
    ...
    trialList=data.importConditions('../Desktop/stroop.xlsx'),
